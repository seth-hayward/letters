...
namespace letterstocrushes.Infrastructure
{
    ...
    public partial class db_mssql : DbContext
    {
        public db_mssql()
            : base("name=db_mssql")
        {
        ...
        public DbSet<my_votes> my_votes { get; set; }
        public DbSet<top_list> top_list { get; set; }
        public DbSet<top_top_list> top_top_list { get; set; }
        ...
        public virtual int AddVote(Nullable<int> voteValue, string voterIP, Nullable<int> letterID)
        {
            var voteValueParameter = voteValue.HasValue ?
                new ObjectParameter("voteValue", voteValue) :
                new ObjectParameter("voteValue", typeof(int));
    
            var voterIPParameter = voterIP != null ?
                new ObjectParameter("voterIP", voterIP) :
                new ObjectParameter("voterIP", typeof(string));
    
            var letterIDParameter = letterID.HasValue ?
                new ObjectParameter("letterID", letterID) :
                new ObjectParameter("letterID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AddVote", voteValueParameter, voterIPParameter, letterIDParameter);
        }
        ...
        public virtual int FixDates()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("FixDates");
        }
    
        public virtual int FrontPageCount_PROC(ObjectParameter p_letter_count)
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("FrontPageCount_PROC", p_letter_count);
        }
    
        public virtual int hideLetter(Nullable<int> letterID)
        {
            var letterIDParameter = letterID.HasValue ?
                new ObjectParameter("letterID", letterID) :
                new ObjectParameter("letterID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("hideLetter", letterIDParameter);
        }
    
        public virtual ObjectResult<lovedLetters_Result> lovedLetters(string ip)
        {
            var ipParameter = ip != null ?
                new ObjectParameter("ip", ip) :
                new ObjectParameter("ip", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<lovedLetters_Result>("lovedLetters", ipParameter);
        }
    
        public virtual int QuickSearch(string searchterm)
        {
            var searchtermParameter = searchterm != null ?
                new ObjectParameter("searchterm", searchterm) :
                new ObjectParameter("searchterm", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("QuickSearch", searchtermParameter);
        }
    
        public virtual int ResetScores()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ResetScores");
        }
    
        public virtual int SethSearch(string searchterm)
        {
            var searchtermParameter = searchterm != null ?
                new ObjectParameter("searchterm", searchterm) :
                new ObjectParameter("searchterm", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SethSearch", searchtermParameter);
        }
        ...
        public virtual ObjectResult<TopList_Result> TopList()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<TopList_Result>("TopList");
        }
    
        public virtual ObjectResult<TopListData_Result> TopListData()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<TopListData_Result>("TopListData");
        }
    }
}
